...
class ForViewHelper extends AbstractViewHelper implements CompilableInterface
{
     ...
     * @param bool $random If enabled, the iteration will in random order
     * @param string $iteration The name of the variable to store iteration information (index, cycle, isFirst, isLast, isEven, isOdd)
     * @return string Rendered string
     * @api
     */
    public function render($each, $as, $key = '', $reverse = false, $random = false, $iteration = null)
    {
    ...
    public static function renderStatic(
        ...
        if (
            ...
            if ($arguments['random'] === true) {
                $arguments['each'] = ArrayUtility::shuffleArrayPreserveKeys($arguments['each']);
            }
