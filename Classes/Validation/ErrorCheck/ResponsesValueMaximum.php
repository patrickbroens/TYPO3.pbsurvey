...
/**
 * Maximum option values validation
 */
class ResponsesValueMaximum extends AbstractErrorCheck
{
    /**
    ...
    public function check(
        ...
        if (
            $item->needsValidator('responsesValueMaximum')
            ...
            $validatorConfiguration = $item->getValidatorConfiguration('responsesValueMaximum');
