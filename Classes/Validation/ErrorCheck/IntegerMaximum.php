...
/**
 * Maximum integer value validation
 */
class IntegerMaximum extends AbstractErrorCheck
{
    /**
     * Check if values are below or equal to maximum
     *
