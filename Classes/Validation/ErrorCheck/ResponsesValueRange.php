...
/**
 * Filled values amount within a range validation
 */
class ResponsesValueRange extends AbstractErrorCheck
{
    /**
    ...
    public function check(
        ...
        if (
            $item->needsValidator('responsesValueRange')
            ...
            $validatorConfiguration = $item->getValidatorConfiguration('responsesValueRange');
