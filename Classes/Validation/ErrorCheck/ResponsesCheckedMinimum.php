...
/**
 * Minimum checked options validation
 */
class ResponsesCheckedMinimum extends AbstractErrorCheck
{
    /**
    ...
    public function check(
        ...
        if (
            $item->needsValidator('responsesCheckedMinimum')
            ...
            $validatorConfiguration = $item->getValidatorConfiguration('responsesCheckedMinimum');
